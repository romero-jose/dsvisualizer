...
# -*- coding: utf-8 -*-
#
# dsvisualizer documentation build configuration file
#
...
project = 'dsvisualizer'
copyright = '2022, Jose Romero'
author = 'Jose Romero'
...
_version_py = os.path.join(repo, 'dsvisualizer', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'dsvisualizerdoc'
...
latex_documents = [
    (master_doc, 'dsvisualizer.tex', 'dsvisualizer Documentation',
     'Jose Romero', 'manual'),
]
